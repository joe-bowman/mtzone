...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		gov.NewAppModuleBasic(
			...
			mtclient.DenomChangeProposalHandler, mtclient.AddMarketsProposalHandler,
		),
...
// MicrotickApp extends an ABCI application, but with most of its parameters exported.
// They are exported for convenience in creating helper functions, as object
// capabilities aren't needed for testing.
type MicrotickApp struct { // nolint: golint
	*baseapp.BaseApp
...
func NewApp(
	...
	govRouter.AddRoute(govtypes.RouterKey, govtypes.ProposalHandler).
		...
		AddRoute(microtick.ModuleName, microtick.MicrotickProposalHandler(app.MicrotickKeeper))
...
// Microtick. It is useful for tests and clients who do not want to construct the
// full microtick application
...
// LegacyAmino returns MicrotickApp's amino codec.
//
...
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *MicrotickApp) AppCodec() codec.Codec {
	return app.appCodec
}
...
func (app *MicrotickApp) RegisterTendermintService(clientCtx client.Context) {
